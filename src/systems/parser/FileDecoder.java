...
public class FileDecoder
{
    ...
    public FileDecoder(String fileName) {
      ...
      this.fileName = "D:\\Engineering\\CCE\\systems programming\\Systems Parser Final\\Systems Parser Final\\src\\systems\\parser\\test.txt";
   ...
   public  int getDecimal(String hex)
   {
    ...
    int opcode_generate ()
    {
        ...
        { op="";
            ...
            else if(listfile.get(i).mnemonic.equals("org")){
               x=l.x;
               l.adress1[x]= listfile.get(i).memory;
               x++;
               l.x=x;
            }
