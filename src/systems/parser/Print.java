...
public class Print {
    ...
    void print(ArrayList<ListFile> x,ArrayList<lblfile> y,int n,int error) {
        try {
            ...
            writer1 = new PrintWriter("D:\\Engineering\\CCE\\systems programming\\Systems Parser Final\\Systems Parser Final\\src\\systems\\parser\\Output.txt");
            writer1.print("");
            writer1.close();
            //try (FileWriter writer = new FileWriter("C:\\Users\\Lenovo\\Desktop\\Systems Parser\\src\\systems\\parser\\Output.txt", true)) {
            try (FileWriter writer = new FileWriter("D:\\Engineering\\CCE\\systems programming\\Systems Parser Final\\Systems Parser Final\\src\\systems\\parser\\Output.txt", true)) {
             //   writer.write("\r\n");
