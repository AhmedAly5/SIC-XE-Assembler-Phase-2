...
public class Print_objfile {
   ...
   public int adress1[] = new int[100];
   public int x=0;
   ...
   void print(){
            try {
                ...
                PrintWriter writer1;
                writer1 = new PrintWriter("D:\\Engineering\\CCE\\systems programming\\Systems Parser Final\\Systems Parser Final\\src\\systems\\parser\\Objfile.txt");
                writer1.print("");
                writer1.close();
                try (FileWriter writer = new FileWriter("D:\\Engineering\\CCE\\systems programming\\Systems Parser Final\\Systems Parser Final\\src\\systems\\parser\\Objfile.txt", true)){
                ...
                writer.write("T"+toHexa(adress1[j])+code_length+opcode+"\n");
